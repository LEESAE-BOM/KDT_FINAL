...
class _expressLearn3 extends State<expressLearn3> {
  ...
  List<int> pointlist= [0,0,0,0,0,0];
              ...
              children: <Widget>[
                ...
                Row(children: [
                  ...
                  SizedBox(
                      ...
                      child: ElevatedButton(onPressed:(){Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Result(pointlist[4]+point!)),
                      );}, child: Text('역겨움',style: textTheme().headline1?.copyWith(
                          color: Colors.white ,fontSize: 20,fontWeight: FontWeight.bold)
                      ),
                          style: ElevatedButton.styleFrom(primary: Colors.blueAccent)
                      )),
                  ...
                  SizedBox(
                      ...
                      child: ElevatedButton(onPressed:(){Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Result(pointlist[5]+point!)),
                      );}, child: Text('놀람',style: textTheme().headline1?.copyWith(
                          color: Colors.white ,fontSize: 20,fontWeight: FontWeight.bold)
                      ),
                          style: ElevatedButton.styleFrom(primary: Colors.blueAccent)
                      )),
